...
from .endpoints.onboarding import router as onboarding_router # Added onboarding router
...
api_router.include_router(onboarding_router, prefix="/onboarding", tags=["Onboarding"]) # Added onboarding router
